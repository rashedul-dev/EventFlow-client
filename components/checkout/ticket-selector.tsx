...
export function TicketSelector({ ticketTypes, onSelectionChange, className }: TicketSelectorProps) {
  ...
  const getAvailability = (ticketType: TicketType) => {
    ...
    if (available <= 10) return { text: `Only ${available} left!`, color: "text-yellow-500" }
      ...
      {ticketTypes.map((ticketType) => {
        ...
        return (
          ...
          >
              ...
              <div className="text-right flex flex-col items-end gap-3">
                <div>
                  ...
                  <span className="text-xl font-bold text-primary">
                    {ticketType.category === "FREE" ? "Free" : formatPrice(ticketType.price, ticketType.currency)}
                  </span>
                </div>
            ...
            {/* Subtotal */}
            {isSelected && ticketType.category !== "FREE" && (
